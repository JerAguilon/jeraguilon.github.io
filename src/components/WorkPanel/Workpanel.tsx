            ...
            <div className="workpanels">
                <div className="circles">
                    <div className="job-entry">
                        ...
                        <div className="timeline-entry">
                            <div className="timeline-entry-title">
                                <h4><b>Google</b> Associate Poduct Management Intern, <small>Summer 2018</small></h4>
                            </div>
                            <p>
                    ...
                    <div className="job-entry">
                        ...
                        <div className="timeline-entry">
                            <div className="timeline-entry-title">
                                <h4><b>Lyft</b> SDE Intern, <small>Winter 2018</small></h4>
                            </div>
                            <p>
                    ...
                    <div className="job-entry">
                        ...
                        <div className="timeline-entry">
                            <div className="timeline-entry-title">
                                <h4><b>Amazon</b> SDE Intern, <small>Summer 2017</small></h4>
                            </div>
                            <p>
                    ...
                    <div className="job-entry">
                        ...
                        <div className="timeline-entry">
                            <div className="timeline-entry-title">
                                <h4><b>Vertafore</b> SDE Intern, <small>Summer 2016</small></h4>
                            </div>
                            <p>
